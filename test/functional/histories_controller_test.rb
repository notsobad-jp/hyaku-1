...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { result: @history.result, song_id: @history.song_id, times: @history.times, user_id: @history.user_id }
    end
  ...
  test "should update history" do
    put :update, id: @history, history: { result: @history.result, song_id: @history.song_id, times: @history.times, user_id: @history.user_id }
    assert_redirected_to history_path(assigns(:history))
  end
